...
const rawData = [
    ...
    ["2025", 2500, "Birla Opus"]
];

const option = {
  title: {
        text: 'Paint Industry Revenue Growth',
            ...
            params.forEach(item => {
                ...
                listHtml += `
                    <div style="margin-top: 4px;">
                        ...
                        ${name}: ${name === "Birla Opus" ? "~" : ""} <b>₹${val.toLocaleString()} Cr</b>
                    </div>
                `;
            });
    ...
    legend: {
        ...
        // Optional: makes the icons look more like "buttons"
        itemGap: 20,
        textStyle: {
            fontWeight: 'bold'
        }
    ...
    series: [
        {
            ...
            data: rawData,
            data: rawData.filter(item => parseInt(item[0]) >= 2016),
            label: { show: false }
        }
    ]
};
